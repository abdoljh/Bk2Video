...
طبِّق هذه القواعد بالترتيب:
1. دمج الأسطر: ألغِ الفواصل الاصطناعية داخل الفقرة الواحدة وحوِّل النص إلى فقرات متدفقة ومتصلة.
2. إصلاح أخطاء OCR: صحِّح الكلمات المشوَّهة آليًّا (مثل: "نباية مؤلة" ← "نهاية مؤلمة") دون تغيير الأسلوب أو إضافة كلمات من عندك.
3. الأسماء التاريخية والجغرافية: احتفظ بها كما وردت في النص.
4. الجمل المفتوحة: لا تضف نقطة نهاية إذا انتهى النص بجملة غير مكتملة (لأنها تكتمل في الصفحة التالية).
5. العناوين والأسماء الرئيسية: أبقِها في أسطر مستقلة.
6. الشمولية: لا تحذف أي محتوى؛ يجب أن يشمل الناتج كل ما ورد في المدخل.
